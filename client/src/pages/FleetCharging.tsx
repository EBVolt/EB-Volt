...
export default function FleetCharging() {
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "oklch(0.98 0.01 240)" }}>
      ...
      {/* Hero Section */}
      <section className="py-16" style={{ background: "linear-gradient(135deg, oklch(0.65 0.18 50) 0%, oklch(0.52 0.18 145) 100%)" }}>
        <div className="container">
          <div className="max-w-2xl">
            ...
            <Link href="/contact">
              <a className="inline-block px-8 py-3 rounded-lg font-semibold transition-all" style={{ background: "white", color: "oklch(0.65 0.18 50)" }}>
                Get a Quote
              </a>
            </Link>
          </div>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { icon: Zap, title: "Priority Access", desc: "Guaranteed charging slots for your vehicles" },
              ...
              { icon: Headphones, title: "Dedicated Support", desc: "24/7 fleet management support team" },
            ].map((benefit, idx) => (
