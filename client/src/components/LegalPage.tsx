      ...
      <section className="pb-20">
        <div className="container">
          <div className="max-w-3xl space-y-8">
            ...
            >
              <Info size={18} style={{ color: "oklch(0.52 0.18 145)", marginTop: 2, flexShrink: 0 }} />
              <p className="text-sm leading-relaxed" style={{ color: "oklch(0.45 0.05 240)" }}>
            ...
            <p className="text-base leading-relaxed" style={{ color: "oklch(0.45 0.05 240)" }}>
              {intro}
            </p>
            ...
            {sections.map((section) => (
              <div key={section.heading}>
                ...
                {section.paragraphs.map((p, i) => (
                  <p key={i} className="text-base leading-relaxed mb-3" style={{ color: "oklch(0.45 0.05 240)" }}>
                    {p}
                  </p>
                ))}
                {section.bullets && (
                  <ul className="space-y-2 mt-2">
                    {section.bullets.map((b, i) => (
                      <li key={i} className="flex items-start gap-2 text-base leading-relaxed" style={{ color: "oklch(0.45 0.05 240)" }}>
                        <span style={{ color: "oklch(0.52 0.18 145)", marginTop: 2 }}>&bull;</span>
                        <span>{b}</span>
                      </li>
                    ))}
                  </ul>
